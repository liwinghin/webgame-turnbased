...
namespace MB
{
    public class CharHat : MonoBehaviour, ICharPart
    {
        public string partName => this.name;

        #region Asset
        public static IEnumerator Load(string path, Action<CharHat> callBack)
        {

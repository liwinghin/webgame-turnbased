...
namespace MB
{
    public class CharFace : MonoBehaviour, ICharPart
    {
        public string partName => this.name;

        #region Resource
        public static IEnumerator Load(string path, Action<CharFace> callBack)
        {

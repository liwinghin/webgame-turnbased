...
namespace MB
{
    public class CharEyewear : MonoBehaviour, ICharPart
    {
        public string partName => this.name;

        #region Asset
        public static IEnumerator Load(string path, Action<CharEyewear> callBack)
        {
